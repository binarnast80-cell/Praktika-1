...
const NODES = {
  ...
  kr1: {
    ...
    age: '3–6 лет', title: 'ДОП. КРУЖКИ (ДОШКОЛ.) 🎨',
  ...
  kr2: {
    ...
    age: '7–11 лет', title: 'ДОП. КРУЖКИ (ШКОЛА) 🎵',
  ...
  kr3: {
    ...
    age: '15–18 лет', title: 'ВОКАЛЬНЫЙ КРУЖОК 🎤',
  ...
  ob1: {
    ...
    age: '15–18 лет', title: 'СТУДЕНЧЕСКОЕ ОБЩЕЖИТИЕ 🏠',
  ...
  ob2: {
    ...
    age: '18–22 лет', title: 'КАМПУС УНИВЕРСИТЕТА 🏠',
